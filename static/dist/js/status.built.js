...
function processWorker(i, worker) {
  ...
  lastModified = lastModified.getHours() + ':' + ('0' + lastModified.getMinutes()).slice(-2) + ':' + ('0' + lastModified.getSeconds()).slice(-2) + ' ' + lastModified.getDate() + ' ' + monthArray[lastModified.getMonth()] + ' ' + lastModified.getFullYear();
...
//# sourceMappingURL=status.built.js.map
