...
<html lang="en">
  <head>
	...
	<meta name="keywords" content="pokemon, go, search, find, vision, hack, cheat, map">
    <link rel="icon" href="../../favicon.ico">

    <title>PokeSear.ch - PoGo</title>
	<meta property="og:title" content="PokeSear.ch - PoGo"/>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="https://pokesear.ch/contact/">Contact</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
      ...
      <div class="jumbotron">
        <h1>PokeSear.ch</h1>
			...
			<div class="well">
				...
				<p> <h3>Twitter: <a href="https://twitter.com/PokeSearchGo">PokeSearchGo</a></h3> </p>
				<p> <h3>Email: contact@pokesear.ch</h3> </p>
